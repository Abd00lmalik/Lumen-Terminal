...
const ALIASES: Readonly<Record<string, string>> = {
  ...
  // asset-class market data (each resolves its own symbol-scoped provider)
  CRYPTO_DATA: "CRYPTO_MARKET_DATA",
  CRYPTO_MARKET: "CRYPTO_MARKET_DATA",
  COMMODITY_DATA: "COMMODITY_MARKET_DATA",
  COMMODITY_MARKET: "COMMODITY_MARKET_DATA",
  FX_DATA: "FX_MARKET_DATA",
  FX_MARKET: "FX_MARKET_DATA",
  FOREX_DATA: "FX_MARKET_DATA",
  FUNDAMENTALS: "EQUITY_FUNDAMENTALS",
  EQUITY_FUNDAMENTAL_DATA: "EQUITY_FUNDAMENTALS",
  // earnings (single canonical name; EQUITY_EARNINGS collapses so one task never fetches the
  // same earnings data twice under two aliases)
  EARNINGS: "EARNINGS_CALENDAR",
  EARNINGS_DATA: "EARNINGS_CALENDAR",
  EARNINGS_HISTORY: "EARNINGS_CALENDAR",
  EARNINGS_ESTIMATES: "EARNINGS_CALENDAR",
  EQUITY_EARNINGS: "EARNINGS_CALENDAR",
