...
const PLAN_SYSTEM = [
  ...
  "- Crypto assets: MARKET_DATA_ANALYSIS, TECHNICAL_ANALYSIS, SENTIMENT_ANALYSIS, NEWS_ANALYSIS, MACRO_ANALYSIS, DERIVATIVES_ANALYSIS (funding/open interest), HISTORICAL_COMPARISON, FALSIFICATION, SOURCE_VALIDATION.",
  ...
  "- Commodities (gold, silver, oil) and FX pairs (EUR/USD etc.): use EQUITY_MARKET_DATA with the asset named in the objective; it resolves arbitrary tickers.",
